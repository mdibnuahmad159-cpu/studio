...
export default function SiswaPage() {
  ...
  const confirmDelete = async () => {
    if(studentToDelete && firestore) {
        ...
        // We will NOT delete the raport document to preserve data
  ...
  const handleImport = () => {
    ...
    reader.onload = async (e) => {
        try {
            ...
            const newStudents = XLSX.utils.sheet_to_json(worksheet) as any[];
                  ...
                  <TableCell>
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                         <Button variant="outline" size="sm" disabled={!student.fileDokumen}>
           ...
           <Dialog open={isImportDialogOpen} onOpenChange={setIsImportDialogOpen}>
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Pilih file Excel untuk mengimpor data siswa. NIS akan digunakan sebagai ID unik. Data yang sudah ada dengan NIS yang sama akan diperbarui.
                </DialogDescription>
              </DialogHeader>
