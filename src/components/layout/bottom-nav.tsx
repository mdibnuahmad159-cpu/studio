...
import { Home, Users, BookMarked, UserCircle, GraduationCap, CalendarDays, BookCopy, FileText, ClipboardCheck } from 'lucide-react';
...
export function BottomNav() {
  ...
  // Split links into two rows for better layout
